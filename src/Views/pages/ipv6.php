...
<form>
    ...
    <input type="text" id="ipv6" value="2001:db8::ff00:42:8329" placeholder="ex : 2001:db8::ff00:42:8329" required>
    <button type="submit" id="simplifier-button">Simplifier</button>
    <button type="submit" id="etendre-button">Etendre</button>
    <button type="submit" id="classify-button">Classifier</button>
</form>
...
<label for="hint-click">
    ...
    <div class="hint">
        ...
        <p style="height: 80%">
            ...
            <br>
            Contrairement à l'IPv4, l'IPv6 offre une plus grande capacité d'adressage, mais sa notation peut sembler
            complexe. Il existe donc une écriture étendue et simplifiée pour faciliter sa lecture et sa gestion. Dans
            l'écriture étendue, tous les zéros sont explicitement écrits, tandis que dans l'écriture simplifiée, les
            zéros redondants peuvent être omis. Par exemple, l'adresse ci-dessus peut être simplifiée en : <code>2001:db8:85a3::8a2e:370:7334</code>.<br>
            <br>
            Classification des adresses IPv6 :<br>
            - Les adresses IPv6 peuvent être classées en plusieurs catégories :<br>
            - Link-Local : Ce type d'adresse est utilisé pour la communication au sein d'un même réseau local, souvent
            avec une portée limitée à un seul segment de réseau (ex. : <code>fe80::1</code>).<br>
            - Globale : Ce type d'adresse est destiné à l'Internet global, et est routable à travers tous les réseaux.
            Exemple : <code>2001:0db8::/32</code>.<br>
            - Locale Unique (LUA) : Ce type d'adresse est réservé pour des usages privés, généralement pour des réseaux
            internes. Exemple : <code>fd00::/8</code>.<br>
            - Non-classifiable : Certaines adresses IPv6 ne rentrent dans aucune des catégories ci-dessus et sont donc
            non classifiables.<br>
            <br>
...
<div class="centerVertical" id="resultDiv"></div>
