...
<?php if ($step === 1): ?>
    ...
    <form action="" method="POST">
        ...
        <input type="text" name="address" id="address" required placeholder="Ex : 192.168.1.30" value="192.168.1.30"/>

        <!-- Champ pour indiquer l'étape actuelle -->
        <input type="hidden" name="step" value="1"/>

        <button type="submit">Détecter le format</button>
    </form>
<?php elseif ($step === 2): ?>
    ...
    <form action="" method="POST">
        <div>
            Format détecté :
            <strong>
                <?php echo ucfirst($adresse_detectee); ?>
            </strong>
            <br>
            Ip demandée :
            <strong>
...
<?php elseif ($step === 3): ?>
    ...
    <?php if (!empty($resultat)): ?>
        <div class="centerVertical"><strong>Résultat pour l'adresse <?php echo htmlspecialchars($address); ?>
                :<br></strong> <?php echo htmlspecialchars($resultat); ?></div>
    <?php endif; ?>
<?php endif; ?>
...
<label for="hint-click">
    ...
    <div class="hint">
        ...
        <p style="height: 80%">
            ...
            - Il est également possible de convertir une adresse en hexadécimal ou binaire en adresse décimale
            pointée.<br>
            ...
            2. Choix du format de sortie : L'utilisateur sélectionne le format(s) de conversion (hexadécimal et/ou
            binaire).<br>
...
<div class="centerVertical">
    ...
    <?php if ($step !== 1): ?>
        <a href="/module_traduction">Revenir en arrière</a>
    <?php endif; ?>
